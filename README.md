...
Copy the master.bank and master.strings.bank file from the Release for the specific game you are installing it to and copy it to the `ts-fmod-plugin-v2` folder.
